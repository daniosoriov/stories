# Sidebar variables
sidebar_how_to_use = """
1. Provide a small prompt to generate a short story.
2. Optionally indicate some of the inputs to personalize your story.
3. Please wait a couple of minutes so the story gets generated.
"""
...
faq = (
    ...
    },
    {
        ...
        'answer': "You input your child's preferences and a story prompt, then our advanced AI creates a unique "
    ...
    {
        'question': "What are some examples of prompts I could use?",
        'answer': """
    ...
    },
    {
        ...
        'answer': "After you input your preferences and prompt, our AI needs a few moments to craft your story. "
                  "So sit back, relax, and let Story Sprout do its magic!",
    },
    {
        'question': "Can I influence the content of the story?",
        'answer': "Yes, you guide the story by providing a prompt and other details about your child's preferences. "
    ...
    },
    {
        ...
        'answer': "Yes, each story generated by Story Sprout is unique, thanks to the input you provide and the "
                  "advanced AI that crafts the story. Even when using similar prompts or preferences, the AI is "
                  "designed to create different narratives, ensuring a fresh and engaging experience each time.",
    },
    {
    ...
    },
    {
        ...
        'answer': "You only need to provide the preferences and inputs that you're comfortable with. Story Sprout "
                  "doesn't require detailed personal information to generate stories. We respect your privacy "
    ...
    },
    {
        ...
        'answer': "We will only save the prompt and generated story for refining purposes. We won't sell your data.",
    },
)

# Main prompt variables
prompt_language_text = 'The stories will be in **English** by default. However, if you wish to have your ' \
                       'story in another language, specify your language on the text area below. For example: ' \
                       '*"Write the story in Spanish"*'
prompt_text_area_help = 'Here you can describe a small guide for the AI to create the story.'
prompt_age_help = 'The age of your child will help us tailor the story for the age group. ' \
                  'We currently support from 2 to 6 years old'
prompt_no_text_error = 'Please write your prompt.\n\n' \
